...
public class TeamActivity extends BaseActivity {
    ...
    protected void onCreate() {
        initLayout(R.layout.activity_team);
        initView();
        initData();
    }
    ...
    private void initData(){
        ...
        expandableListBeen = new ArrayList<>();
        listBean = new ExpandableListBean("http://1b6093f923.51mypc.cn/res/2017/02/14872303862009c0e1b55.jpg", "协会1");
        expandableListBeen.add(listBean);
        listBean = new ExpandableListBean("http://1b6093f923.51mypc.cn/res/2017/02/14872303862009c0e1b55.jpg", "协会2");
        expandableListBeen.add(listBean);
        listBean = new ExpandableListBean("http://1b6093f923.51mypc.cn/res/2017/02/14872303862009c0e1b55.jpg", "协会3");
        expandableListBeen.add(listBean);
        listBean = new ExpandableListBean("http://1b6093f923.51mypc.cn/res/2017/02/14872303862009c0e1b55.jpg", "协会4");
        expandableListBeen.add(listBean);
        childArray.add(expandableListBeen);
